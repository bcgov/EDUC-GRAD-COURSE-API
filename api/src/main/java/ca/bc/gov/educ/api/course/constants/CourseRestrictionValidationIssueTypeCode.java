...
public enum CourseRestrictionValidationIssueTypeCode {
    ...
    RESTRICTION_END_DATE_INVALID("restrictionEndDate", "Restriction Start Date is later than the latest completion date of the two courses" , ValidationIssueSeverityCode.ERROR),
