...
CREATE INDEX "EVENT_STATUS_IDX" ON "STATUS_EVENTS" ("EVENT_STATUS")
TABLESPACE "API_GRAD_IDX";

CREATE INDEX "EVENT_TYPE_IDX" ON "STATUS_EVENTS" ("EVENT_TYPE")
TABLESPACE "API_GRAD_IDX";

COMMENT ON TABLE STATUS_EVENTS IS 'This table is used to store all the received choreographed events from different api via pub/sub model and process them.';

GRANT SELECT ON STATUS_EVENTS TO GRAD_READONLY;
